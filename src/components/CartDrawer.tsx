          ...
          >
            ...
            <div className="flex-none border-b border-slate-100 bg-white px-6 py-5">
              <div className="flex items-center justify-between">
                ...
                <button onClick={onClose} className="rounded-full bg-slate-100 p-2.5 text-slate-500 hover:bg-slate-200 active:scale-95 transition-transform">
                  <X className="h-6 w-6" />
                </button>
              </div>
            </div>
            ...
            {/* Scrollable Content */}
            <div className="flex-1 overflow-y-auto p-6 pb-[300px]">
              {cartItems.length === 0 ? (
                ...
                <div className="space-y-3">
                  ...
                  <div className="bg-slate-50 p-2.5 rounded-[1.5rem] border border-slate-100">
                    ...
                    <button
                      ...
                      className="w-full relative overflow-hidden rounded-2xl bg-emerald-500 py-4 text-xl font-black text-white shadow-lg shadow-emerald-500/20 transition-all hover:bg-emerald-600 hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50 disabled:scale-100 disabled:shadow-none"
                    >
